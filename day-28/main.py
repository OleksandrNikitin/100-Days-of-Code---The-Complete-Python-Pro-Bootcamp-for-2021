...
timer_label = tk.Label(text="Timer", bg=YELLOW, fg=GREEN, highlightthickness=0, font=(FONT_NAME, 20, "bold"))
timer_label.grid(column=1, row=0)

check_mark_label = tk.Label(bg=YELLOW, fg=GREEN, highlightthickness=0,

...
first_question = input("Where do you want to go? Left or Right?\n").lower()

if first_question != "left":
    print("You are falling into a hole. Game Over.")
else:
    second_question = input("Do you want to swim or wait? Swim or Wait?\n").lower()
    if second_question != "wait":
        ...
        if third_question == "Blue":
            ...
            print("You have been found a treasure. You Win")
        else:
            print("Game Over")
